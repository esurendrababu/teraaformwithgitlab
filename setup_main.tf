...
resource "aws_s3_bucket" "example" {
  bucket = "surendrababuetukuritestbycketterra7788abcdededded0or40ffxxc"

  tags = {
    Name        = "surendrababuetukuritestbycketterra7788abcdededded0or40ffxxc"
    Environment = "Dev"
  }
}
